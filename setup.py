...
class tag(Command):
    ...
    def run(self):
        ...
        with open('./pyramid_errbit/_version.py', 'w') as f:
...
setup(
    ...
    description='Bindings for the pyramid webframework and the errbit reporting system.',
    license='MIT',
    keywords='',
    url='https://github.com/bitesofcode/pyramid_errbit',
